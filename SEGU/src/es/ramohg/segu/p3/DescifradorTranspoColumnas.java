...
public class DescifradorTranspoColumnas {
	...
	/**
	 * Nos informa de si una matriz tiene todos sus espacios en las últimas columnas de la última fila
	 * @param matriz es la matriz que se comprueba
	 * @return si todos los espacios están al final o no
	 */
	private boolean matrizTieneEspaciosSoloAlFinal(char[][] matriz) {
		...
		//Recorro las últimas espaciosTotales columnas buscando espacios
	...
	/**
	 * Pasa una matriz a una string juntando todas sus filas en una única línea quitando los espacios "_"
	...
	/**
	 * Obtiene la combinación de columnas usada para cifrar un texto a partir de la combinación
	 * de columnas usada para descifrar dicho texto
	 * @param combColsDesc la combinación de columnas usada para descifrar el texto
	 * @return la combinación de columnas usada para cifrar el texto
	 */
	...
	/**
	 * Devuelve una clave textual a partir de una combinación de columnas usada para cifrar
	 * @param combColsCif la combinación de columnas usada para cifrar un texto
